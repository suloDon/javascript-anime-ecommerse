...
cart.forEach((cartItem) => {
    ...
    js-cart-${matching.id}">
        ...
        <div class="cart-item-details">
            ...
            <span class="delete-quantity-link link-primary js-delet-buttom" 
            data-product-name = "${matching.id}">
                Delete
            </span>
            </div>
        </div>
...
document.querySelectorAll(".js-delet-buttom")
    .forEach((button) => {
